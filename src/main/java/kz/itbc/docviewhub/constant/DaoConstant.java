...
public class DaoConstant {
    ...
    public static final String ADD_COMPANY_SQL_QUERY = "INSERT INTO Companies (NameRU, NameKZ, BIN, GovOrgNumber, ServerAddress, FlagDeleted) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public static final String GET_COMPANY_ID_SQL_QUERY = "SELECT * FROM Companies WHERE NameRU = ?, NameKZ = ?, " +
            "BIN = ?, GovOrgNumber = ?, ServerAddress = ?";
    ...
    public static final String INSERT_DOCUMENT_QUEUE_SQL_QUERY = "INSERT INTO DocumentQueue (ID_SenderCompany, ID_RecipientCompany, " +
            "JsonData, RecieveDate, ID_DocumentStatus, ID_ClientDocumentQueue, FlagDeleted) VALUES (?, ?, ?, ?, ?, ?, ?)";
